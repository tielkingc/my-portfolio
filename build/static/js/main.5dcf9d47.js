...
/* harmony export (immutable) */ __webpack_exports__["a"] = validateParams;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_EmailJSResponseStatus__ = __webpack_require__(28);
...
const sendPost = (url, data, headers = {}) => {
    return new Promise((resolve, reject) => {
        ...
        xhr.addEventListener('load', ({ target }) => {
            const responseStatus = new __WEBPACK_IMPORTED_MODULE_0__models_EmailJSResponseStatus__["a" /* EmailJSResponseStatus */](target);
        ...
        xhr.addEventListener('error', ({ target }) => {
            reject(new __WEBPACK_IMPORTED_MODULE_0__models_EmailJSResponseStatus__["a" /* EmailJSResponseStatus */](target));
        });
        xhr.open('POST', __WEBPACK_IMPORTED_MODULE_1__store_store__["a" /* store */]._origin + url, true);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = sendPost;
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(2),r=__webpack_require__(19);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Contact__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_emailjs_com__ = __webpack_require__(25);
Object(__WEBPACK_IMPORTED_MODULE_1_emailjs_com__["b" /* init */])('user_ja2wZURnqKxM1uQwQNyxz');function Contact(){function sendEmail(e){e.preventDefault();var serviceID='service_e9o1aii';var templateID='template_zvz7u1g';__WEBPACK_IMPORTED_MODULE_1_emailjs_com__["a" /* default */].sendForm(serviceID,templateID,e.target).then(function(result){console.log(result.text);window.location.reload();},function(error){console.log(error.text);});}return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('section',{id:'contact',className:'relative'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('form',{onSubmit:sendEmail,name:'contact',className:'flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h2',{className:'text-white sm:text-4xl text-3xl mb-1 font-medium title-font'},'Contact Me'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'leading-relaxed mb-5'},'Please feel free to reach out to better get to know me or ask me any questions!'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'from_name',className:'leading-7 text-sm text-gray-400'},'Name'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input',{type:'text',id:'from_name',name:'from_name',className:'w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'from_email',className:'leading-7 text-sm text-gray-400'},'Email'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input',{type:'email',id:'from_email',name:'from_email',className:'w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'message',className:'leading-7 text-sm text-gray-400'},'Message'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea',{id:'message',name:'message',className:'w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button',{type:'submit',className:'text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg'},'Submit'))));}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__methods_init_init__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__methods_send_send__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__methods_sendForm_sendForm__ = __webpack_require__(29);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__methods_init_init__["a"]; });
...
/* harmony default export */ __webpack_exports__["a"] = ({
    init: __WEBPACK_IMPORTED_MODULE_0__methods_init_init__["a" /* init */],
    send: __WEBPACK_IMPORTED_MODULE_1__methods_send_send__["a" /* send */],
    sendForm: __WEBPACK_IMPORTED_MODULE_2__methods_sendForm_sendForm__["a" /* sendForm */],
});
...
const init = (userID, origin = 'https://api.emailjs.com') => {
    __WEBPACK_IMPORTED_MODULE_0__store_store__["a" /* store */]._userID = userID;
    __WEBPACK_IMPORTED_MODULE_0__store_store__["a" /* store */]._origin = origin;
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store_store__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_validateParams__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_sendPost__ = __webpack_require__(6);
...
const send = (serviceID, templateID, templatePrams, userID) => {
    const uID = userID || __WEBPACK_IMPORTED_MODULE_0__store_store__["a" /* store */]._userID;
    Object(__WEBPACK_IMPORTED_MODULE_1__utils_validateParams__["a" /* validateParams */])(uID, serviceID, templateID);
    const params = {
        lib_version: '3.2.0',
        user_id: uID,
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_2__api_sendPost__["a" /* sendPost */])('/api/v1.0/email/send', JSON.stringify(params), {
...
const sendForm = (serviceID, templateID, form, userID) => {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_2__api_sendPost__["a" /* sendPost */])('/api/v1.0/email/send-form', formData);
};
